...
const ERC721Mock = artifacts.require("BlockdegreeNFT");
...
contract("ERC721", function (accounts) {
  ...
  describe("metadata", function () {
    ...
    describe("token URI", function () {
      ...
      //   await expectRevert.unspecified(await this.token.tokenURI(firstTokenId));
      // });
    ...
    describe("transfers", function () {
      ...
      const transferWasSuccessful = function ({ owner, tokenId, approved }) {
        ...
        it("emits an Approval event", async function () {
          ...
          console.log("logslogs", logs, tokenId);

          expectEvent.inLogs(logs, "Approval", {
            _owner: owner,
            _approved: ZERO_ADDRESS,
            _tokenId: tokenId,
          });
        });
  ...
  //       await expectRevert.unspecified(this.token.mint(owner, firstTokenId), 'ERC721: token already minted');
  //     });
  //   });
  // });
